        ...
        if(request.getMethod().compareToIgnoreCase("post")==0)
        {
                try
                {
                        ...
                        String uyeTel = request.getParameter("uyeTel");
                         ...
                         String query = "INSERT INTO merinos(uyeId,uyeAd,uyeSoyad,aracModel,uyePlaka,uyeTel) VALUES (?,?,?,?,?,?)";
...
<div class="form-aracekle">
            <form id="form" method="post" class="form2" action="merinos.jsp">
                ...
                <div class="form-group clearfix" >
                    <div class="col-25">
                        <label for="telefon">Arac Sahibinin Telefon Numarasi</label>
                    </div>
                    <div class="col-75">
